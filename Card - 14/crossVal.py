...
# Padrão de folds é 10
# shuffle => pegar valores aleatórios
...
for indice_treinamento, indice_teste in kfold.split(
    previsores, np.zeros(shape=(classe.shape[0], 1))
):
    ...
    # Método retorna 2 posições, a loss function e o resultado da precisão
